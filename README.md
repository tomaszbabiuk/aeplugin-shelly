...
This is a plugin for [Automate-Everything](https://github.com/tomaszbabiuk/automate-everything). It provides a support for some Shelly devices. The plugin is unofficial.
...
git clone https://github.com/tomaszbabiuk/aeplugin-shelly.git
```
...
```
After running the server, go to http://localhost/plugins/hardware and enable "Shelly" plugin
...
Before lunch:
 - run gradle task: aeplugin-shelly:buildForAutomateEverything
